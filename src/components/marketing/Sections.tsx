...
function MiniGuests() {
  return (
    <div className="mt-6 flex items-center gap-3 overflow-hidden">
      ...
      <span className="rounded-full bg-blush-deep px-2.5 py-1 text-[0.62rem] font-bold text-cream transition-transform duration-500 group-hover:translate-x-1">RSVP · yes</span>
...
function MiniVendors() {
  return (
    <div className="mt-6 flex flex-wrap gap-2">
      <span className="rounded-full bg-blush-deep px-3 py-1.5 text-[0.66rem] font-bold text-cream transition-transform duration-500 group-hover:-translate-y-0.5">Booked · Aria Studio</span>
      ...
      <span className="rounded-full border border-dashed border-ink/25 bg-white/60 px-3 py-1.5 text-[0.66rem] font-bold text-ink-2">Contract ✓</span>
    </div>
  );
}
    ...
    <section id="features" className="relative mx-auto max-w-7xl scroll-mt-28 px-5 py-24 sm:px-8 sm:py-32">
      ...
      <div className="mt-14 grid gap-5 md:grid-cols-6">
        ...
        <Reveal className="md:col-span-6" delay={0.1}>
          <article className="group relative overflow-hidden rounded-[2.2rem] border border-white/70 bg-gradient-to-r from-white/60 via-blush-soft/60 to-parchment p-7 backdrop-blur-md transition-all duration-500 hover:-translate-y-1.5 hover:shadow-lift sm:p-9">
  ...
  return (
    <section id="how" className="scroll-mt-28 px-5 py-24 sm:px-8 sm:py-32">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[3rem] bg-ink px-7 py-16 sm:px-14 sm:py-20">
        ...
        <Reveal>
          <p className="flex items-center gap-3 text-[0.68rem] font-extrabold uppercase tracking-[0.28em] text-blush">
          ...
          {STEPS.map((s, i) => (
            <Reveal key={s.n} delay={i * 0.14}>
              <div className="relative lg:border-l lg:border-cream/10 lg:pl-8">
                ...
                <p className="text-[0.66rem] font-extrabold uppercase tracking-[0.24em] text-blush">Step {s.n}</p>
